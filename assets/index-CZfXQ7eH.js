...
void main() {
	...
	`}class tM extends ss{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new $S(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const n={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			`},r=new oc(5,5,5),a=new us({name:"CubemapFromEquirect",uniforms:Al(n.uniforms),vertexShader:n.vertexShader,fragmentShader:n.fragmentShader,side:Wi,blending:Ps});a.uniforms.tEquirect.value=t;const u=new ks(r,a),c=t.minFilter;return t.minFilter===ia&&(t.minFilter=hi),new fA(1,10,this).update(e,u),t.minFilter=c,u.geometry.dispose(),u.material.dispose(),this}clear(e,t=!0,n=!0,r=!0){const a=e.getRenderTarget();for(let u=0;u<6;u++)e.setRenderTarget(this,u),e.clear(t,n,r);e.setRenderTarget(a)}}function sb(o){let e=new WeakMap,t=new WeakMap,n=null;function r(_,g=!1){return _==null?null:g?u(_):a(_)}function a(_){if(_&&_.isTexture){const g=_.mapping;if(g===Tp||g===wp)if(e.has(_)){const M=e.get(_).texture;return c(M,_.mapping)}else{const M=_.image;if(M&&M.height>0){const E=new tM(M.height);return E.fromEquirectangularTexture(o,_),e.set(_,E),_.addEventListener("dispose",h),c(E.texture,_.mapping)}else return null}}return _}function u(_){if(_&&_.isTexture){const g=_.mapping,M=g===Tp||g===wp,E=g===ha||g===El;if(M||E){let x=t.get(_);const S=x!==void 0?x.texture.pmremVersion:0;if(_.isRenderTargetTexture&&_.pmremVersion!==S)return n===null&&(n=new kx(o)),x=M?n.fromEquirectangular(_,x):n.fromCubemap(_,x),x.texture.pmremVersion=_.pmremVersion,t.set(_,x),x.texture;if(x!==void 0)return x.texture;{const A=_.image;return M&&A&&A.height>0||E&&A&&d(A)?(n===null&&(n=new kx(o)),x=M?n.fromEquirectangular(_):n.fromCubemap(_),x.texture.pmremVersion=_.pmremVersion,t.set(_,x),_.addEventListener("dispose",p),x.texture):null}}}return _}function c(_,g){return g===Tp?_.mapping=ha:g===wp&&(_.mapping=El),_}function d(_){let g=0;const M=6;for(let E=0;E<M;E++)_[E]!==void 0&&g++;return g===M}function h(_){const g=_.target;g.removeEventListener("dispose",h);const M=e.get(g);M!==void 0&&(e.delete(g),M.dispose())}function p(_){const g=_.target;g.removeEventListener("dispose",p);const M=t.get(g);M!==void 0&&(t.delete(g),M.dispose())}function v(){e=new WeakMap,t=new WeakMap,n!==null&&(n.dispose(),n=null)}return{get:r,dispose:v}}function ob(o){const e={};function t(n){if(e[n]!==void 0)return e[n];const r=o.getExtension(n);return e[n]=r,r}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const r=t(n);return r===null&&Sd("WebGLRenderer: "+n+" extension not supported."),r}}}function ab(o,e,t,n){const r={},a=new WeakMap;function u(v){const _=v.target;_.index!==null&&e.remove(_.index);for(const M in _.attributes)e.remove(_.attributes[M]);_.removeEventListener("dispose",u),delete r[_.id];const g=a.get(_);g&&(e.remove(g),a.delete(_)),n.releaseStatesOfGeometry(_),_.isInstancedBufferGeometry===!0&&delete _._maxInstanceCount,t.memory.geometries--}function c(v,_){return r[_.id]===!0||(_.addEventListener("dispose",u),r[_.id]=!0,t.memory.geometries++),_}function d(v){const _=v.attributes;for(const g in _)e.update(_[g],o.ARRAY_BUFFER)}function h(v){const _=[],g=v.index,M=v.attributes.position;let E=0;if(M===void 0)return;if(g!==null){const A=g.array;E=g.version;for(let b=0,C=A.length;b<C;b+=3){const L=A[b+0],I=A[b+1],N=A[b+2];_.push(L,I,I,N,N,L)}}else{const A=M.array;E=M.version;for(let b=0,C=A.length/3-1;b<C;b+=3){const L=b+0,I=b+1,N=b+2;_.push(L,I,I,N,N,L)}}const x=new(M.count>=65535?WS:GS)(_,1);x.version=E;const S=a.get(v);S&&e.remove(S),a.set(v,x)}function p(v){const _=a.get(v);if(_){const g=v.index;g!==null&&_.version<g.version&&h(v)}else h(v);return a.get(v)}return{get:c,update:d,getWireframeAttribute:p}}function lb(o,e,t){let n;function r(_){n=_}let a,u;function c(_){a=_.type,u=_.bytesPerElement}function d(_,g){o.drawElements(n,g,a,_*u),t.update(g,n,1)}function h(_,g,M){M!==0&&(o.drawElementsInstanced(n,g,a,_*u,M),t.update(g,n,M))}function p(_,g,M){if(M===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,g,0,a,_,0,M);let x=0;for(let S=0;S<M;S++)x+=g[S];t.update(x,n,1)}function v(_,g,M,E){if(M===0)return;const x=e.get("WEBGL_multi_draw");if(x===null)for(let S=0;S<_.length;S++)h(_[S]/u,g[S],E[S]);else{x.multiDrawElementsInstancedWEBGL(n,g,0,a,_,0,E,0,M);let S=0;for(let A=0;A<M;A++)S+=g[A]*E[A];t.update(S,n,1)}}this.setMode=r,this.setIndex=c,this.render=d,this.renderInstances=h,this.renderMultiDraw=p,this.renderMultiDrawInstances=v}function ub(o){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(a,u,c){switch(t.calls++,u){case o.TRIANGLES:t.triangles+=c*(a/3);break;case o.LINES:t.lines+=c*(a/2);break;case o.LINE_STRIP:t.lines+=c*(a-1);break;case o.LINE_LOOP:t.lines+=c*a;break;case o.POINTS:t.points+=c*a;break;default:Wt("WebGLInfo: Unknown draw mode:",u);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:n}}function cb(o,e,t){const n=new WeakMap,r=new Pn;function a(u,c,d){const h=u.morphTargetInfluences,p=c.morphAttributes.position||c.morphAttributes.normal||c.morphAttributes.color,v=p!==void 0?p.length:0;let _=n.get(c);if(_===void 0||_.count!==v){let W=function(){T.dispose(),n.delete(c),c.removeEventListener("dispose",W)};var g=W;_!==void 0&&_.texture.dispose();const M=c.morphAttributes.position!==void 0,E=c.morphAttributes.normal!==void 0,x=c.morphAttributes.color!==void 0,S=c.morphAttributes.position||[],A=c.morphAttributes.normal||[],b=c.morphAttributes.color||[];let C=0;M===!0&&(C=1),E===!0&&(C=2),x===!0&&(C=3);let L=c.attributes.position.count*C,I=1;L>e.maxTextureSize&&(I=Math.ceil(L/e.maxTextureSize),L=e.maxTextureSize);const N=new Float32Array(L*I*4*v),T=new zS(N,L,I,v);T.type=ts,T.needsUpdate=!0;const D=C*4;for(let k=0;k<v;k++){const H=S[k],K=A[k],ee=b[k],Z=L*I*4*k;for(let Q=0;Q<H.count;Q++){const V=Q*D;M===!0&&(r.fromBufferAttribute(H,Q),N[Z+V+0]=r.x,N[Z+V+1]=r.y,N[Z+V+2]=r.z,N[Z+V+3]=0),E===!0&&(r.fromBufferAttribute(K,Q),N[Z+V+4]=r.x,N[Z+V+5]=r.y,N[Z+V+6]=r.z,N[Z+V+7]=0),x===!0&&(r.fromBufferAttribute(ee,Q),N[Z+V+8]=r.x,N[Z+V+9]=r.y,N[Z+V+10]=r.z,N[Z+V+11]=ee.itemSize===4?r.w:1)}}_={count:v,texture:T,size:new en(L,I)},n.set(c,_),c.addEventListener("dispose",W)}if(u.isInstancedMesh===!0&&u.morphTexture!==null)d.getUniforms().setValue(o,"morphTexture",u.morphTexture,t);else{let M=0;for(let x=0;x<h.length;x++)M+=h[x];const E=c.morphTargetsRelative?1:1-M;d.getUniforms().setValue(o,"morphTargetBaseInfluence",E),d.getUniforms().setValue(o,"morphTargetInfluences",h)}d.getUniforms().setValue(o,"morphTargetsTexture",_.texture,t),d.getUniforms().setValue(o,"morphTargetsTextureSize",_.size)}return{update:a}}function fb(o,e,t,n,r){let a=new WeakMap;function u(h){const p=r.render.frame,v=h.geometry,_=e.get(h,v);if(a.get(_)!==p&&(e.update(_),a.set(_,p)),h.isInstancedMesh&&(h.hasEventListener("dispose",d)===!1&&h.addEventListener("dispose",d),a.get(h)!==p&&(t.update(h.instanceMatrix,o.ARRAY_BUFFER),h.instanceColor!==null&&t.update(h.instanceColor,o.ARRAY_BUFFER),a.set(h,p))),h.isSkinnedMesh){const g=h.skeleton;a.get(g)!==p&&(g.update(),a.set(g,p))}return _}function c(){a=new WeakMap}function d(h){const p=h.target;p.removeEventListener("dispose",d),n.releaseStatesOfObject(p),t.remove(p.instanceMatrix),p.instanceColor!==null&&t.remove(p.instanceColor)}return{update:u,dispose:c}}const db={[TS]:"LINEAR_TONE_MAPPING",[wS]:"REINHARD_TONE_MAPPING",[AS]:"CINEON_TONE_MAPPING",[CS]:"ACES_FILMIC_TONE_MAPPING",[bS]:"AGX_TONE_MAPPING",[PS]:"NEUTRAL_TONE_MAPPING",[RS]:"CUSTOM_TONE_MAPPING"};function hb(o,e,t,n,r){const a=new ss(e,t,{type:o,depthBuffer:n,stencilBuffer:r}),u=new ss(e,t,{type:Us,depthBuffer:!1,stencilBuffer:!1}),c=new cr;c.setAttribute("position",new Gr([-1,3,0,-1,-1,0,3,-1,0],3)),c.setAttribute("uv",new Gr([0,2,0,0,2,0],2));const d=new lA({uniforms:{tDiffuse:{value:null}},vertexShader:`
			precision highp float;
